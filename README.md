...
### This current README is outdated. I don't have yet the time to update the preprint and the comparisons for the major changes to the algorithm in the latest v2.0 RC version. Most issues to aliasing and texture loss are solved in the latest version of the algorithm. A more rigorous and in-depth preprint is coming soon.
